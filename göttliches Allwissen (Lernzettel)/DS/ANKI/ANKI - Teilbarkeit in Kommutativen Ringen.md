...
In welchen Ringen ist die Teilbarkeitsrelation definiert #flashcard
Nur in *kommutativen* Ringen
<!--ID: 1769083724290-->


Definiere die Teilbarkeitsrelation auf einem kommutativen Ring #flashcard 
"$a$ teilt $b$" oder "$b$ ist Vielfaches von $a$"
$$a\mid b :\!\iff \exists_{q\in R}:b=qa$$
<!--ID: 1769083724295-->


Definiere die Assoziertheitsrelation auf einem kommutativen Ring  #flashcard
Es existiert eine *Einheit* $u\in R^{\times}$ so dass
$$a\sim b :\!\iff \exists_{u\in R^{\times}}:b=ua$$
<!--ID: 1769083724298-->


Welcher Zusammenhang gilt zwischen Teilbarkeits- und Assoziertheitsrelation: #flashcard
Es gilt auf jedem kommutativen Ring:
$$
a \sim b \implies a|b \land b|a
$$
Auf Integritätsbereichen gilt sogar:
$$
