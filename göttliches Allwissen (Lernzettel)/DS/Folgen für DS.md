...
## Beispiele
- Die Folge der Quadratzahlen ist $f:\mathbb{N}\to \mathbb{N},i\mapsto i^{2}$ bzw. $1,4,9,16,\dots$ bzw. $(i^{2})_{i\in \mathbb{N}}$
- Die Menge aller Binärfolgen ist $\{ 0,1 \}^{\mathbb{N}}$
- Die Menge aller Folgen von reellen Zahlen ist $\mathbb{R}^{\mathbb{N}}$ 
