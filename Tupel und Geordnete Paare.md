...
Man kann zeigen, das beide Ansätze equivalent sind.
...
Man kann Geordnete Paare/Tupel auch direkt aus Mengen konstruieren, ohne dafür Abbildungen zu benötigen: $(x,y)$ lässt sich konstruieren als $\{ \{ \emptyset,\{ x \} \},\{ y \} \}$ wobei die Verschachtelungslevel die Reihenfolge angeben. Ebenso ist dies für beliebige Größen möglich: $(x,y,z)$ kann konstruiert werden als  $\{ x, \}$
